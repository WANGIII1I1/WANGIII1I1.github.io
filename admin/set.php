			...
			<div class="panel-body">
				<form action="" method="post" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-10"><textarea class="form-control" id="web_notice1" name="notice1" rows="5"><?php echo htmlspecialchars($conf['notice1']);?></textarea></div>
					</div><br/>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" name="submit" value="保存修改" class="btn btn-primary form-control"/><br/>
						</div>
					</div>
				</form>
			</div>
			...
			<div class="panel-body">
				<form action="" method="post" class="form-horizontal" role="form">
					<div class="form-group">
						...
						<div class="col-lg-8">
							<select class="form-control" id="payapi" name="payapi" onchange="showepayurlinput(this.value)">
                                             <option value="1">请选择支付接口!</option>                
						             <option value="9"  <?php if($conf['payapi']==9) echo "selected"; ?>>自定义易支付接口  格式：http://域名/</option>
						             	</select>
							<font style="color: green;"><a href="http://www.kmlcsm.cn" style="color:#00c13d">点击进入樱花码支付三网实时到账自己钱包</a></font>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
                                                    <input type="text" id="epay_key" name="epay_key" class="form-control" value="<?php echo trim($conf['epay_key']);?>">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-8"><input type="submit" name="submit" value="保存修改" class="btn btn-primary form-control"/><br/>
						</div>
