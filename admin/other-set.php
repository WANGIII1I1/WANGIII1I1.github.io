...
<script src="/assets/js/ayangwfk.js"></script>
<?php
...
<?php
            ...
            ?>
               <div class="panel panel-primary" >
        <div class="panel-heading" style="border:1px solid FFFF00;background: linear-gradient(to right,	#B9D3EE,#B5B5B5,#B9D3EE);color:black"><h3 class="panel-title">首页模板参数配置</h3></div>
        <div class="panel-body" >
...
?>
<div class="panel panel-primary" >
        <div class="panel-heading" style="border:1px solid FFFF00;background: linear-gradient(to right,		#B9D3EE,#B5B5B5,#B9D3EE);color:black"><h3 class="panel-title">首页模板设置</h3></div>
        <div class="panel-body" >
    ...
    <div class="panel-body">
        ...
        <div style="margin-top: 20px;color:black">
            <span style="color:red;font-weight: bold">模板作者：葫芦侠龙少</span><br>
            <span style="color:blue">更新时间：2020/08/10</span><br>
            <a style="color:pink" href="http://www.zv0.cn">作者官网：www.zv0.cn</a><br>
